...
// Define the database...
    ...
    $query = "INSERT INTO `werehouse_list` SET `werehouse_id`=$num , `werehouse_name`='$nm' , `werehouse_type`='$typ', `werehouse_extension`=$ex" ;
        ...
        if($result)
                {
                    header("location:add_werehouse.php?status=1");      
                }
                else 
                {
                    header("location:add_werehouse.php?status=0");
                }
    }
            ...
            <!-- start the content --> 
                ...
                <?php } else if(isset($_GET['status']) AND $_GET['status']==0) {?>
                    ...
                    <?php } else{?>
                        ...
                        <p class="category" style="border-bottom: 2px solid #2E8B57; border-top: 2px solid #2E8B57">Adding new Werehouse</p>
                    
                 <form action="add_werehouse.php" method="post"> 
                     <!-- start of first row of the form -->
                    <div class="row">
                     <div class="col-md-2">
                         <div class="form-group label-floating">
                             
                            <label class="control-label">Werehouse Number</label>
                            <input type="text" class="form-control" name="number" placeholder="Type the werehouse number here">
                     ...
                     <div class="col-md-7">
                         <div class="form-group label-floating">
                             ...
                             <input type="text" class="form-control" name="name" placeholder="Type the werehouse name here">
                 ...
                 <div class="row">
                   ...
                   <div class="col-md-7">
                        <div class="form-group label-floating">
                            ...
                            <label class="control-label">Werehouse Type:</label>
                            <select class="form-control" name="type">
                                <option>-------------</option>
                                <option>Refrigerated</option>
                                <option>Un-Refrigerated</option>
                     ...
                     <div class="col-md-7">
                         <div class="form-group label-floating">
                             ...
                             <label class="control-label">Werehouse Extension Number</label>
                             <input type="text" class="form-control" name="ext" placeholder="Type the werehouse extension number here">
                     ...
                     <button id="btn" type="submit" name="btn" value="submit" class="btn btn-success pull-right">Add Werehouse</button>
